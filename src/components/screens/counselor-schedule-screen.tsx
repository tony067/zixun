              ...
              <div className="px-5 pb-10 space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-xs" style={{ color: "#9B8E82" }}>开始时间</p>
                    {form.startTime && (
                      <span className="text-xs font-semibold" style={{ color: "#9CB48A" }}>
                        {form.startTime}–{timeEnd(form.startTime, typeof form.durationMinutes === "number" ? form.durationMinutes : 50)}
                      </span>
                    )}
                  </div>
                  {([["早上",[6,12]],["下午",[12,18]],["晚上",[18,23]]] as const).map(([label, [from, to]]) => {
