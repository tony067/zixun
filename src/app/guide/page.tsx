...
第一次也是你评估咨询师是否适合自己的机会。你可以问咨询师任何关于咨询方式、保密原则、费用等问题。`,
  },
  {
    ...
    content: `大多数咨询每 1-2 周进行一次，每次 50-60 分钟。具体频率可以和咨询师讨论。

短期目标性咨询通常 6-12 次；长期深度工作可能持续一年以上。没有「应该做多久」的标准——完全由你和咨询师共同决定。`,
  },
  {
    title: "关于保密原则",
    short: "咨询内容受保密保护，有限例外请了解。",
    content: `咨询内容受严格保密保护。除以下有限情形外，咨询师不会向任何第三方透露：

• 你有伤害自己或他人的紧迫风险
• 涉及未成年人保护的法定报告义务
• 法院要求披露

如有疑问，可以在第一次咨询时直接向咨询师确认。`,
  },
  {
    title: "预约和取消政策",
    short: "请提前 24 小时取消，避免产生费用。",
    content: `请至少提前 24 小时取消或改期，否则可能按全额或部分收费。
            ...
            <AnimatePresence>
              {open === i && (
                <motion.div initial={{ height: 0 }} animate={{ height: "auto" }} exit={{ height: 0 }} className="overflow-hidden">
                  <p className="px-4 pb-4 text-sm leading-relaxed whitespace-pre-line border-t" style={{ color: "#5A4E44", borderColor: "#F0EBE4" }}>
                    {"\n"}{s.content}
                  </p>
                </motion.div>
              )}
